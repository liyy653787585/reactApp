...
- [redis 主从架构](https://github.com/wulimax/reactApp/blob/master/docs/DistributedCache/redis-master-slave.md)
- [redis 基于哨兵实现高可用](https://github.com/wulimax/reactApp/blob/master/docs/DistributedCache/redis-sentinel.md)
